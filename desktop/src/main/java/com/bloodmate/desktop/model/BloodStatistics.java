...
public class BloodStatistics {
    ...
    public void setBloodGroupDistribution(String distribution) {
        this.bloodGroupDistribution.set(distribution);
    }
    ...
    public String toString() {
        return "BloodStatistics{" +
                ...
                ", aPositiveUnits=" + aPositiveUnits.get() +
                ", aNegativeUnits=" + aNegativeUnits.get() +
                ", bPositiveUnits=" + bPositiveUnits.get() +
                ", bNegativeUnits=" + bNegativeUnits.get() +
                ", abPositiveUnits=" + abPositiveUnits.get() +
                ", abNegativeUnits=" + abNegativeUnits.get() +
                ", oPositiveUnits=" + oPositiveUnits.get() +
                ", oNegativeUnits=" + oNegativeUnits.get() +
                '}';
    }
}
